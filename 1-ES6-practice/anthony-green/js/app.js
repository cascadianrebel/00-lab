...
function displayPics(){
  ...
  // When I changed 'var' to 'let', I changed the scope of the variable. 'Var' allows for the variable to be scoped within the the whole displayPics function. 'Let' restricts the scope of the variable to the specific code block (lines 31 to line 35)
  console.log(viewed)
